...
values
 (1,
  ...
  "Petit train en bois",
  "Je donne un set de chemin de fer en bois. Etat comme neuf. Très peu servi.",
  2,
  4,
  1),
 (2,
 ...
 (3,
  ...
  "Cafetière Senséo",
  "Je donne une cafetière Senséo Phillips. Jamais servi, sous emballage d'origine.",
  1,
  5,
  2),
 (4,
 ...
 (5,
  ...
  "Je fais don de mon ordinateur. Apprenez à le dompter et vous serez satisfait.",
  2,
  8,
  3);
...
values
  ...
  "J'offre des services de bricolage en électricité, plomberie, montage de meubles, etc...",
  1,
  1),
 (2,
  "2024-12-05",
